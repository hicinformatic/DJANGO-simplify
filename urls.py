...
#██║ ╚═╝ ██║███████╗   ██║   ██║  ██║╚██████╔╝██████╔╝
#╚═╝     ╚═╝╚══════╝   ╚═╝   ╚═╝  ╚═╝ ╚═════╝ ╚═════╝
urlpatterns.append(re_path(r'{ns}/method/(?P<pk>\d+)/check(\.|/)?(html)?/?'.format(**conf_path), views.MethodCheck.as_view(), name='method-check'))
#urlpatterns.append(re_path(r'{ns}/method/(?P<pk>\d+)/check(\.|/)?(json)?/?'.format(**conf_path), views.MethodCheckJSON.as_view(), name='method-check-json'))
